    ...
    override fun onBindViewHolder(
       ...
       holder.itemView.setOnClickListener {
           ...
           CoroutineScope(Dispatchers.IO).launch() {
               ...
               val product3 = Product(item1.id,item1.title,item1.description,item1.price,item1.discountPercentage,item1.rating,item1.stock,item1.brand,item1.category,item1.thumbnail,images)
